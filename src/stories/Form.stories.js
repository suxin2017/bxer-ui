...
export const 基本用法 = () => (
  <Form style={{ width: "300px" }} onSubmit={action("onSubmit")}>
    <FormItem
      wrapperSpan={{ span: 8 }}
      labelSpan={{ span: 4 }}
    ...
    <FormItem wrapperSpan={{ span: 8 }} labelSpan={{ span: 4 }} label="单选">
...
export const 父组件控制布局 = () => {
  return (
    ...
    >
      ...
      <FormItem isRequest label="复选框" dataKey={"checkout"}>
        <CheckboxGroup>
          <Checkbox value={"test"}>北京</Checkbox>
          <Checkbox value={"test1"}>上海</Checkbox>
        </CheckboxGroup>
      </FormItem>
      <FormItem label="单选" dataKey={"radio"}>
        <RadioGroup>
          <Radio value={"test"}>北京</Radio>
          <Radio value={"test1"}>上海</Radio>
        </RadioGroup>
      </FormItem>
      <FormItem label="单选" dataKey={"datepicker"}>
        <DatePicker></DatePicker>
      </FormItem>
      <FormItem label="单选">
        <Button htmltype={"submit"}>确定</Button>
